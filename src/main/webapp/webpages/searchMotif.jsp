...
<main>
    ...
    <ul  style="margin-left: 50px">
        <li class="normal"><button><a href="./searchSpectralSimilarity.jsp">Spectral similarity search</a></button></li>
        <li class="normal active"><button><a href="./searchMotif.jsp">motif search combined with neutral loss scanning</a></button></li>
